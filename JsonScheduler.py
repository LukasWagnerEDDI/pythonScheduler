...
if __name__ == '__main__':
	...
	if not RedisConnect.hget('apscheduler.jobs', mainJobId):
		job = scheduler.add_job(scheduleJobs,'interval',seconds=5,start_date='2010-10-10 09:30:00',replace_existing=True,next_run_time=datetime.now(),id=mainJobId)
		...
		RedisConnect.hset('apscheduler.jobs', f'{mainJobId}.info', json.dumps(jsonString, default=str))
